document.addEventListener('DOMContentLoaded', async () => {
  ...
  async function loadData() {
    try {
      ...
      document.getElementById('contactMax').value = mainpageData.contacts?.max || '';
      document.getElementById('contactWhatsapp').value = mainpageData.contacts?.whatsapp || '';
      document.getElementById('contactTelegram').value = mainpageData.contacts?.telegram || '';
      document.getElementById('contactVk').value = mainpageData.contacts?.vk || '';
      document.getElementById('contactOk').value = mainpageData.contacts?.ok || '';
  ...
  saveBtn.addEventListener('click', async () => {
    ...
    mainpageData.contacts.max = document.getElementById('contactMax').value;
    mainpageData.contacts.whatsapp = document.getElementById('contactWhatsapp').value;
    mainpageData.contacts.telegram = document.getElementById('contactTelegram').value;
    mainpageData.contacts.vk = document.getElementById('contactVk').value;
    mainpageData.contacts.ok = document.getElementById('contactOk').value;
